...
function getAllArticle(req, res) {
  const url = `${domain}/api/v1/hot-articles`;
  axios.get(url).then((response) => {
    ...
    axios.get(`${domain}/api/v1/last-articles`).then((responseLast) => {
...
function getTechArticle(req, res) {
  axios.get(`${domain}/api/v1/sec-aritcles/Technology`).then((response) => {
    ...
    axios.get(`${domain}/api/v1/hot-article/Technology`).then((responseHotTech) => {
...
function getEduArticle(req, res) {
  axios.get(`${domain}/api/v1/sec-aritcles/Education`).then((response) => {
    ...
    axios.get(`${domain}/api/v1/hot-article/Education`).then((responseHotEdu) => {
...
function getSpArticle(req, res) {
  axios.get(`${domain}/api/v1/sec-aritcles/Sports`).then((response) => {
    ...
    axios.get(`${domain}/api/v1/hot-article/Sports`).then((responseHotSp) => {
...
function getWoArticle(req, res) {
  axios.get(`${domain}/api/v1/sec-aritcles/World`).then((response) => {
    ...
    axios.get(`${domain}/api/v1/hot-article/World`).then((responseHotWo) => {
...
function getFaArticle(req, res) {
  axios.get(`${domain}/api/v1/sec-aritcles/Family`).then((response) => {
    ...
    axios.get(`${domain}/api/v1/hot-article/Family`).then((responseHotFa) => {
